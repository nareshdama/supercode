...
- Re-run the release gate in [RELEASE-CHECKLIST.md](RELEASE-CHECKLIST.md) before each tagged release candidate.
- Continue MCP and plugin adversarial testing as post-Phase-8 hardening work, not as release blockers for this milestone.
